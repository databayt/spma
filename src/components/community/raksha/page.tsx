  ...
  return (
    <div className="px-7 pt-28">
      ...
      <p className="text-[18px] font-light tracking-wider  pb-7">
        Raksha is dedicated to converting gasoline-powered tuk-tuks into
        electric vehicles, <br /> to <strong>contribute</strong>, you may track
        the ongoing development by reviewing the Readme, Code, Design and
